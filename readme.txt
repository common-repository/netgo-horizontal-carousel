=== Horizontal Carousel ===
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=afroz92@gmail.com&item_name=Netgo+Horizontal+Carousel
...
2. Back end add Image.
3. Back end Carousel shortcode list page.
4. Back end add shortcodes.
5. Front end slider look.
